...
object MicrochessService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The microchess service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MicrochessService.
  */
trait MicrochessService extends Service {
  ...
  override final def descriptor = {
    ...
    named("microchess")
      ...
      .withTopics(
        topic(MicrochessService.TOPIC_NAME, greetingsTopic _)
